...
export const SITE: Site = {
    author: 'Logan',
    url: 'https://citynight.cn',
    title: '碎碎念',
    description: 'Logan\'s personal blog, I enjoy the process of building something using any technology stack',
    shortDescription: '',
}
...
export const NavigationLinks: NavigationLink[] = [
    ...
    { name: 'About', url: '/posts/about-logan' },
...
export const FooterLinks = [
    {
        ...
        links: [
            ...
            { name: 'About Me', url: '/posts/about-logan' },
        ],
    },
    {
        section: 'Other',
        links: [
            ...
            { name: 'Twitter', url: 'https://x.com/citynight' },
        ],
    },
]
